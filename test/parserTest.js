...
describe("parser", function() {
  ...
  test("normal with class with underscore and dash", 'Text img.logo-1_b.cls#id(src="image.png")img(src="image2.png")', ["image.png", "image2.png"]);
  ...
  test("comment3", '//- img(src="image.png")', ["image.png"]); //TODO
  test("comment4", '<!---->img(src="image.png")-->', ["image.png"]);
  test("tags", 'img(src="image.png")\nscript(src="script.js")\nlink(type="stylesheet", href="style.css")', ["image.png", "style.css"]);
